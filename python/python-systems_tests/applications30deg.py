...
tilt = 30               #Angle between module and horizontal plane
# Tilts:                 10      15      20      30      45      60      90
pitch = 4               #Distance between row centers
# Pitch                   x       x       x       4       5       6       x
clearance = 0.3800      #Distance between ground and lower lip under module
