...
tilt = 10               #Angle between module and horizontal plane
# Tilts:                 10      15      20      30      45      60      90
pitch = 3               #Distance between row centers
# Pitch                   x       x       x       4       5       6       x
clearance = 0.1407      #Distance between ground and lower lip under module
...
Times:
    ...
    10-deg:
        Single Radiance run:
            total time   :    6.101534128189087
            sensors      :    0.33150410652160645
            octfiles     :    0.1248011589050293
            analysis     :    5.139245986938477
            output       :    0.1796417236328125
            mismatch     :    0.3263411521911621
        
        Radiance:
            total time   :    41.22614789009094
            sensors      :    0.3272225856781006
            octfiles     :    2.195523500442505
            analysis     :    29.305925130844116
            output       :    3.2548410892486572
            mismatch     :    6.1426355838775635
