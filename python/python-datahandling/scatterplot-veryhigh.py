...
folder = 'C:\\Users\\ingeb\\Documents\\Master\\applications\\bf_files\\real_results'
...
ax0.scatter(maxabserrsP1,accrelerrP1, color = 'b', label = '10deg high \nerror', marker = 'o')
ax0.scatter(maxabserrsP2,accrelerrP2, color = 'g', label = '30deg high \nerror', marker = 'o')
ax0.scatter(maxabserrsP3,accrelerrP3, color = 'y', label = '50deg high \nerror', marker = 'o')
ax0.scatter(maxabserrsP4,accrelerrP4, color = 'c', label = '70deg high \nerror', marker = 'o')
ax0.scatter(maxabserrsP5,accrelerrP5, color = 'k', label = '90deg high \nerror', marker = 'o')
...
"""
-------------------------------------------------
plot new errors after very high Radiance runs
"""

#Create list for accelerad results for the 20 highest error hours
ACCresP1 = []
ACCresP2 = []
ACCresP3 = []
ACCresP4 = []
...
#the results file sorts after module name and date, so dates must be sorted
# (from low to high)
datesPH1 = np.sort(np.array(datesP1))
datesPH2 = np.sort(np.array(datesP2))
datesPH3 = np.sort(np.array(datesP3))
print(datesPH3)
datesPH4 = np.sort(np.array(datesP4))
datesPH5 = np.sort(np.array(datesP5))



for time in range(20):
    timeP1 = datesPH1[time]
    timeP2 = datesPH2[time]
    timeP3 = datesPH3[time]
    timeP4 = datesPH4[time]
    timeP5 = datesPH5[time]
    ACCresP1.append(totPA1[timeP1])
    ACCresP2.append(totPA2[timeP2])
    ACCresP3.append(totPA3[timeP3])
    ACCresP4.append(totPA4[timeP4])
    ACCresP5.append(totPA5[timeP5])

ACCresP1 = np.array(ACCresP1)

ACCresP2 = np.array(ACCresP2)
ACCresP3 = np.array(ACCresP3)
ACCresP4 = np.array(ACCresP4)
ACCresP5 = np.array(ACCresP5)

#Get new very high Radiance results
filename3 = '10-90deg-RAD-veryhigh' + '-results.csv'
file3 = folder + '\\' + filename3
df3 = pd.read_csv(file3)
Parray3 = df3['pmp'].to_numpy()
totPRH1 = Parray3[0:20]
totPRH2 = Parray3[20:40]
totPRH3 = Parray3[40:60]
totPRH4 = Parray3[60:80]
totPRH5 = Parray3[80:100]    

#recalculate errors
relerrPH1 = 100*(ACCresP1 - totPRH1)/totPRH1
relerrPH2 = 100*(ACCresP2 - totPRH2)/totPRH2
relerrPH3 = 100*(ACCresP3 - totPRH3)/totPRH3
relerrPH4 = 100*(ACCresP4 - totPRH4)/totPRH4
relerrPH5 = 100*(ACCresP5 - totPRH5)/totPRH5

abserrPH1 = ACCresP1 - totPRH1
abserrPH2 = ACCresP2 - totPRH2
abserrPH3 = ACCresP3 - totPRH3
abserrPH4 = ACCresP4 - totPRH4
abserrPH5 = ACCresP5 - totPRH5

fig1, ax1 = plt.subplots(1,1, figsize=(8,6))

#ax1.scatter(maxabserrsP1,accrelerrP1, color = 'b', label = '10deg high error', marker = 'o', alpha = 0.2)
#ax1.scatter(maxabserrsP2,accrelerrP2, color = 'g', label = '30deg high error', marker = 'o', alpha = 0.2)
#ax1.scatter(maxabserrsP3,accrelerrP3, color = 'y', label = '50deg high error', marker = 'o', alpha = 0.2)
#ax1.scatter(maxabserrsP4,accrelerrP4, color = 'c', label = '70deg high error', marker = 'o', alpha = 0.2)
#ax1.scatter(maxabserrsP5,accrelerrP5, color = 'k', label = '90deg high error', marker = 'o', alpha = 0.2)


ax1.scatter(abserrPH1,relerrPH1, color = 'b', label = '10deg improved', marker = 'o')
ax1.scatter(abserrPH2,relerrPH2, color = 'g', label = '30deg improved', marker = 'o')
ax1.scatter(abserrPH3,relerrPH3, color = 'y', label = '50deg improved', marker = 'o')
ax1.scatter(abserrPH4,relerrPH4, color = 'c', label = '70deg improved', marker = 'o')
ax1.scatter(abserrPH5,relerrPH5, color = 'k', label = '90deg improved', marker = 'o')


ax1.axis('scaled')
#ax1.set_xlim(-30, 15)
#ax1.set_ylim(-30, 5)
ax1.set_title('Module output errors with Radiance "very high" parameters')
ax1.set_xlabel('Absolute error (W)')
